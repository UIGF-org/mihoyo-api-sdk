...
def build_build_api_get_build_request(
    *, branch: str, package_id: str, password: str, tag: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    ...
    # Construct URL
    _url = "/downloader/sophon_chunk/api/getBuild"

    # Construct parameters
    _params["branch"] = _SERIALIZER.query("branch", branch, "str")
    _params["package_id"] = _SERIALIZER.query("package_id", package_id, "str")
...
def build_build_api_get_patch_build_request(
    *, branch: str, package_id: str, password: str, tag: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/downloader/sophon_chunk/api/getPatchBuild"
...
class BuildApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.passport.GlobalSophonClient`'s
