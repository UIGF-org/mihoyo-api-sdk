...
def build_user_api_get_full_info_request(*, cookie: str, ds: Optional[str] = None, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/community/user/wapi/getUserFullInfo"
...
def build_genshin_challenge_api_get_spiral_abyss_request(  # pylint: disable=name-too-long
    *,
    cookie: str,
    ds: str,
    server: str,
...
def build_genshin_challenge_api_get_imaginarium_theater_request(  # pylint: disable=name-too-long
    *,
    cookie: str,
    ds: str,
    server: str,
...
def build_genshin_challenge_api_get_stygian_onslaught_request(  # pylint: disable=name-too-long
    *,
    cookie: str,
    ds: str,
    server: str,
...
def build_star_rail_challenge_api_get_forgotten_hall_request(  # pylint: disable=name-too-long
    *,
    cookie: str,
    ds: str,
    server: str,
...
def build_star_rail_challenge_api_get_pure_fiction_request(  # pylint: disable=name-too-long
    *,
    cookie: str,
    ds: str,
    server: str,
...
def build_star_rail_challenge_api_get_apocalyptic_shadow_request(  # pylint: disable=name-too-long
    *,
    cookie: str,
    ds: str,
    server: str,
...
def build_star_rail_challenge_api_get_simulated_universe_request(  # pylint: disable=name-too-long
    *,
    cookie: str,
    ds: str,
    server: str,
...
def build_honkai_impact_api_get_daily_note_request(  # pylint: disable=name-too-long
    *, cookie: str, server: str, role_id: str, ds: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/game_record/app/honkai3rd/api/note"
...
class UserApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.passport.CommunityRecordsClient`'s
