...
def build_binding_api_get_roles_request(*, cookie: str, game_biz: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/binding/api/getUserGameRolesByCookieToken"
...
class BindingApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.passport.GlobalGameAccountClient`'s
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: GlobalGameAccountClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
        self._serialize: Serializer = input_args.pop(0) if input_args else kwargs.pop("serializer")
        self._deserialize: Deserializer = input_args.pop(0) if input_args else kwargs.pop("deserializer")

    def get_roles(self, *, cookie: str, game_biz: str, **kwargs: Any) -> _models4.ApiResponseGameRoleList:
        """get_roles.
