...
from ...operations._operations import build_binding_api_get_roles_request
...
class BindingApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.passport.aio.GlobalGameAccountClient`'s
    ...
    async def get_roles(self, *, cookie: str, game_biz: str, **kwargs: Any) -> _models5.ApiResponseGameRoleList:
        """get_roles.
