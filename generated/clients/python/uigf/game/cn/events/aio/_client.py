...
from .operations import StarRailLedgerApiOperations, ZenlessCultivationApiOperations, ZenlessLedgerApiOperations
...
class EventsClient:  # pylint: disable=client-accepts-api-version-keyword
    """CN ledger and Zenless cultivation-tool APIs.

    :ivar star_rail_ledger_api: StarRailLedgerApiOperations operations
    :vartype star_rail_ledger_api: uigf.passport.aio.operations.StarRailLedgerApiOperations
    :ivar zenless_ledger_api: ZenlessLedgerApiOperations operations
    :vartype zenless_ledger_api: uigf.passport.aio.operations.ZenlessLedgerApiOperations
    :ivar zenless_cultivation_api: ZenlessCultivationApiOperations operations
    :vartype zenless_cultivation_api: uigf.passport.aio.operations.ZenlessCultivationApiOperations
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        _endpoint = "{endpoint}"
        self._config = EventsClientConfiguration(endpoint=endpoint, **kwargs)
