...
from ...operations._operations import (
    build_secure_api_compare_protocol_version_request,
    build_secure_api_get_red_dots_request,
)
...
class SecureApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.passport.aio.SecureClient`'s
    ...
    @overload
    async def compare_protocol_version(
        self,
        body: _models3.ProtocolVersionRequest,
        *,
    ...
    async def compare_protocol_version(
        self,
        body: _types_models3.ProtocolVersionRequest,
        *,
        rpc_app_id: Optional[str] = None,
        rpc_app_version: Optional[str] = None,
        rpc_channel_id: Optional[str] = None,
    ...
    async def compare_protocol_version(  # pylint: disable=too-many-locals
        self,
        body: Union[_models3.ProtocolVersionRequest, _types_models3.ProtocolVersionRequest, IO[bytes]],
        *,
        rpc_app_id: Optional[str] = None,
        rpc_app_version: Optional[str] = None,
        rpc_channel_id: Optional[str] = None,
    ...
    @overload
    async def get_red_dots(
        self,
        body: _models3.RedDotRequest,
        *,
        rpc_app_id: Optional[str] = None,
        rpc_app_version: Optional[str] = None,
        rpc_channel_id: Optional[str] = None,
    ...
    async def get_red_dots(
        self,
        body: _types_models3.RedDotRequest,
        *,
        rpc_app_id: Optional[str] = None,
        rpc_app_version: Optional[str] = None,
        rpc_channel_id: Optional[str] = None,
    ...
    async def get_red_dots(  # pylint: disable=too-many-locals
        self,
        body: Union[_models3.RedDotRequest, _types_models3.RedDotRequest, IO[bytes]],
        *,
        rpc_app_id: Optional[str] = None,
        rpc_app_version: Optional[str] = None,
        rpc_channel_id: Optional[str] = None,
