...
def build_config_api_get_combo_request(  # pylint: disable=too-many-locals
    *,
    biz_key: str,
    client_type: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/combo/box/api/config/sdk/combo"

    # Construct parameters
    _params["biz_key"] = _SERIALIZER.query("biz_key", biz_key, "str")
    _params["client_type"] = _SERIALIZER.query("client_type", client_type, "str")
...
def build_config_api_get_precache_request(  # pylint: disable=too-many-locals
    *,
    biz: str,
    client: str,
    rpc_app_id: Optional[str] = None,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/combo/box/api/config/sw/precache"

    # Construct parameters
    _params["biz"] = _SERIALIZER.query("biz", biz, "str")
    _params["client"] = _SERIALIZER.query("client", client, "str")
...
def build_config_api_get_granter_config_request(  # pylint: disable=name-too-long,too-many-locals
    *,
    app_id: str,
    channel_id: str,
    client_type: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/hk4e_cn/combo/granter/api/getConfig"
...
def build_config_api_get_shield_config_request(  # pylint: disable=name-too-long,too-many-locals
    *,
    client: str,
    game_key: str,
    rpc_app_id: Optional[str] = None,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/hk4e_cn/mdk/shield/api/loadConfig"

    # Construct parameters
    _params["client"] = _SERIALIZER.query("client", client, "str")
    _params["game_key"] = _SERIALIZER.query("game_key", game_key, "str")
...
class ConfigApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.passport.ConfigClient`'s
    ...
    def get_combo(  # pylint: disable=too-many-locals
        self,
        *,
        biz_key: str,
        client_type: str,
    ...
    def get_precache(  # pylint: disable=too-many-locals
        self,
        *,
        biz: str,
        client: str,
    ...
    def get_granter_config(  # pylint: disable=too-many-locals
        self,
        *,
        app_id: str,
        channel_id: str,
    ...
    def get_shield_config(  # pylint: disable=too-many-locals
        self,
        *,
        client: str,
        game_key: str,
