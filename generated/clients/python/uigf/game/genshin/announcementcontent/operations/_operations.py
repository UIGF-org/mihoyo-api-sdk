...
def build_content_api_get_request(
    *,
    game: str,
    game_biz: str,
    lang: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/common/hk4e_cn/announcement/api/getAnnContent"

    # Construct parameters
    if t is not None:
        _params["t"] = _SERIALIZER.query("t", t, "str")
...
class ContentApiOperations:  # pylint: disable=docstring-missing-param
    """
    .. warning::
        **DO NOT** instantiate this class directly.

        Instead, you should access the following operations through
        :class:`~uigf.passport.AnnouncementContentClient`'s
        :attr:`content_api` attribute.
    """

    def __init__(self, *args, **kwargs) -> None:
        input_args = list(args)
        self._client: PipelineClient = input_args.pop(0) if input_args else kwargs.pop("client")
        self._config: AnnouncementContentClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :keyword t: Default value is None.
        :paramtype t: str
        ...
        _request = build_content_api_get_request(
            game=game,
            game_biz=game_biz,
            lang=lang,
            bundle_id=bundle_id,
