...
class LoginClient:  # pylint: disable=client-accepts-api-version-keyword
    """Deprecated official QR login endpoints retained for compatibility with TeyvatGuide.

    :ivar panda_qr_api: PandaQrApiOperations operations
    :vartype panda_qr_api: uigf.passport.operations.PandaQrApiOperations
    :ivar granter_api: GranterApiOperations operations
    :vartype granter_api: uigf.passport.operations.GranterApiOperations
    :keyword endpoint: Service host. Default value is "https://hk4e-sdk.mihoyo.com".
    :paramtype endpoint: str
    """

    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        self, *, endpoint: str = "https://hk4e-sdk.mihoyo.com", **kwargs: Any
    ) -> None:
        _endpoint = "{endpoint}"
        self._config = LoginClientConfiguration(endpoint=endpoint, **kwargs)
