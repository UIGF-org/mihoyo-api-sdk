...
from ...sdk import models as _sdk_models3, types as _types_sdk_models3
...
def build_panda_qr_api_create_request(**kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/hk4e_cn/combo/panda/qrcode/fetch"
...
def build_panda_qr_api_get_status_request(**kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/hk4e_cn/combo/panda/qrcode/query"
...
def build_granter_api_login_request(
    *,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/hk4e_cn/combo/granter/login/v2/login"
...
class PandaQrApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.passport.LoginClient`'s
    ...
    @overload
    def create(
        self, body: _models3.PandaQrRequest, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models4.ApiResponsePandaQrResponse:
    ...
    @overload
    def create(
        self, body: _types_models3.PandaQrRequest, *, content_type: str = "application/json", **kwargs: Any
    ) -> _models4.ApiResponsePandaQrResponse:
        """The upstream endpoint is deprecated; use only where officially supported.
    ...
    def create(
        self, body: Union[_models3.PandaQrRequest, _types_models3.PandaQrRequest, IO[bytes]], **kwargs: Any
    ) -> _models4.ApiResponsePandaQrResponse:
        """The upstream endpoint is deprecated; use only where officially supported.
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models4.ApiResponsePandaQrResponse] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponsePandaQrResponse, response.json())
...
class GranterApiOperations:  # pylint: disable=docstring-missing-param
    ...
    def login(
        self,
        body: _sdk_models3.GranterLoginRequest,
        *,
        rpc_app_id: Optional[str] = None,
        rpc_app_version: Optional[str] = None,
        rpc_channel_id: Optional[str] = None,
    ...
    def login(
        self,
        body: _types_sdk_models3.GranterLoginRequest,
        *,
        rpc_app_id: Optional[str] = None,
        rpc_app_version: Optional[str] = None,
        rpc_channel_id: Optional[str] = None,
    ...
    def login(  # pylint: disable=too-many-locals
        self,
        body: Union[_sdk_models3.GranterLoginRequest, _types_sdk_models3.GranterLoginRequest, IO[bytes]],
        *,
        rpc_app_id: Optional[str] = None,
        rpc_app_version: Optional[str] = None,
        rpc_channel_id: Optional[str] = None,
