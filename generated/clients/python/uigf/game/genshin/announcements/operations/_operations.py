...
def build_announcement_api_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/common/hk4e_cn/announcement/api/getAnnList"
...
def build_announcement_api_get_alert_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/common/hk4e_cn/announcement/api/getAlertAnn"
...
def build_announcement_api_get_alert_picture_request(  # pylint: disable=name-too-long
    *,
    game: str,
    game_biz: str,
    lang: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/common/hk4e_cn/announcement/api/getAlertPic"
...
class AnnouncementApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.passport.AnnouncementsClient`'s
