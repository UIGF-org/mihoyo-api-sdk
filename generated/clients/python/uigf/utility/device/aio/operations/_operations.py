...
class FingerprintApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.passport.aio.DeviceClient`'s
    ...
    async def get_fingerprint(
        self,
        body: _game_models5.DeviceFingerprintRequest,
        *,
        app_version: str,
        client_type: str,
        requested_with: str,
        ...
        **kwargs: Any
    ) -> _models4.ApiResponseDeviceFingerprint:
    ...
    async def get_fingerprint(
        self,
        body: _types_game_models5.DeviceFingerprintRequest,
        *,
        app_version: str,
        client_type: str,
        requested_with: str,
    ...
    async def get_fingerprint(
        self,
        body: Union[_game_models5.DeviceFingerprintRequest, _types_game_models5.DeviceFingerprintRequest, IO[bytes]],
        *,
        app_version: str,
        client_type: str,
        requested_with: str,
        **kwargs: Any
        ...
        cls: ClsType[_models4.ApiResponseDeviceFingerprint] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseDeviceFingerprint, response.json())
