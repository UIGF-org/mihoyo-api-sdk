...
class DeviceClientConfiguration:
    ...
    :param endpoint: Service host. Default value is "https://public-data-api.mihoyo.com".
    :type endpoint: str
    """

    def __init__(self, endpoint: str = "https://public-data-api.mihoyo.com", **kwargs: Any) -> None:
