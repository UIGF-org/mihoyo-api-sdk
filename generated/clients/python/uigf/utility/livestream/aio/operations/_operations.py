...
from ...operations._operations import build_redemption_code_api_refresh_request
...
class RedemptionCodeApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.passport.aio.LiveStreamClient`'s
    ...
    async def refresh(self, *, activity_id: str, **kwargs: Any) -> _models4.ApiResponseJsonObject:
        """refresh.
