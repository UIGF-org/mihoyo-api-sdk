...
class CommunityClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype misc_api: uigf.passport.aio.operations.MiscApiOperations
    :ivar collection_api: CollectionApiOperations operations
    :vartype collection_api: uigf.passport.aio.operations.CollectionApiOperations
    :ivar coin_record_api: CoinRecordApiOperations operations
    :vartype coin_record_api: uigf.passport.aio.operations.CoinRecordApiOperations
    :ivar post_api: PostApiOperations operations
    :vartype post_api: uigf.passport.aio.operations.PostApiOperations
    :ivar feed_api: FeedApiOperations operations
    :vartype feed_api: uigf.passport.aio.operations.FeedApiOperations
    :ivar topic_api: TopicApiOperations operations
    :vartype topic_api: uigf.passport.aio.operations.TopicApiOperations
    :ivar api_hub: ApiHubOperations operations
    :vartype api_hub: uigf.passport.aio.operations.ApiHubOperations
