...
from .._configuration import PassportV4ClientConfiguration
...
def build_session_api_verify_l_token_request(*, cookie: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/account/ma-cn-session/web/verifyLtoken"
...
class SessionApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.passport.PassportV4Client`'s
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: PassportV4ClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
        self._serialize: Serializer = input_args.pop(0) if input_args else kwargs.pop("serializer")
        self._deserialize: Deserializer = input_args.pop(0) if input_args else kwargs.pop("deserializer")

    @overload
    def verify_l_token(
        self, body: _models2.JsonObject, *, cookie: str, content_type: str = "application/json", **kwargs: Any
    ...
    @overload
    def verify_l_token(
        self, body: _types_models2.JsonObject, *, cookie: str, content_type: str = "application/json", **kwargs: Any
    ) -> _models2.ApiResponseTokenInfo:
        """verify_l_token.
    ...
    def verify_l_token(
        self, body: Union[_models2.JsonObject, _types_models2.JsonObject, IO[bytes]], *, cookie: str, **kwargs: Any
    ) -> _models2.ApiResponseTokenInfo:
        """verify_l_token.
        ...
        _request = build_session_api_verify_l_token_request(
            cookie=cookie,
