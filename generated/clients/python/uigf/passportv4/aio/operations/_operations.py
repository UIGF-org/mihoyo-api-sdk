...
from ...operations._operations import build_session_api_verify_l_token_request
...
class SessionApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.passport.aio.PassportV4Client`'s
    ...
    @overload
    async def verify_l_token(
        self, body: _models3.JsonObject, *, cookie: str, content_type: str = "application/json", **kwargs: Any
    ...
    @overload
    async def verify_l_token(
        self, body: _types_models3.JsonObject, *, cookie: str, content_type: str = "application/json", **kwargs: Any
    ) -> _models3.ApiResponseTokenInfo:
        """verify_l_token.
    ...
    async def verify_l_token(
        self, body: Union[_models3.JsonObject, _types_models3.JsonObject, IO[bytes]], *, cookie: str, **kwargs: Any
    ) -> _models3.ApiResponseTokenInfo:
        """verify_l_token.
