...
class GameClientConfiguration:
    ...
    :param endpoint: Service host. Default value is "https://ys-log-upload.mihoyo.com".
    :type endpoint: str
    """

    def __init__(self, endpoint: str = "https://ys-log-upload.mihoyo.com", **kwargs: Any) -> None:
