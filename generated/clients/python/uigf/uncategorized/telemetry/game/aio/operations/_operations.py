...
from ...operations._operations import (
    build_performance_api_verify_request,
    build_upload_api_upload_crash_request,
    build_upload_api_upload_custom_request,
    build_upload_api_upload_sdk_request,
)
...
class PerformanceApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.passport.aio.GameClient`'s
    ...
    async def verify(self, *, device_id: str, name: str, platform: str, **kwargs: Any) -> _models4.UploadResponse:
        """verify.
