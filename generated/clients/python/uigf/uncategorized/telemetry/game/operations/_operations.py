...
def build_performance_api_verify_request(*, device_id: str, name: str, platform: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = "/perf/config/verify"

    # Construct parameters
    _params["device_id"] = _SERIALIZER.query("device_id", device_id, "str")
...
def build_upload_api_upload_crash_request(
    *,
...
def build_upload_api_upload_sdk_request(
    *,
    authorization: Optional[str] = None,
    content_md5: Optional[str] = None,
    date: Optional[str] = None,
...
def build_upload_api_upload_custom_request(
    *,
    authorization: Optional[str] = None,
    content_md5: Optional[str] = None,
    date: Optional[str] = None,
...
class PerformanceApiOperations:  # pylint: disable=docstring-missing-param
    """
    .. warning::
        **DO NOT** instantiate this class directly.

        Instead, you should access the following operations through
        :class:`~uigf.passport.GameClient`'s
        :attr:`performance_api` attribute.
    """

    def __init__(self, *args, **kwargs) -> None:
        input_args = list(args)
        self._client: PipelineClient = input_args.pop(0) if input_args else kwargs.pop("client")
        self._config: GameClientConfiguration = input_args.pop(0) if input_args else kwargs.pop("config")
        self._serialize: Serializer = input_args.pop(0) if input_args else kwargs.pop("serializer")
        self._deserialize: Deserializer = input_args.pop(0) if input_args else kwargs.pop("deserializer")

    def verify(self, *, device_id: str, name: str, platform: str, **kwargs: Any) -> _models3.UploadResponse:
        """verify.
        ...
        _request = build_performance_api_verify_request(
            device_id=device_id,
            name=name,
            platform=platform,
            headers=_headers,
...
class UploadApiOperations:  # pylint: disable=docstring-missing-param
    ...
    def upload_crash(
        ...
        **kwargs: Any
        ...
        _request = build_upload_api_upload_crash_request(
    ...
    def upload_sdk(
        ...
        **kwargs: Any
        ...
        _request = build_upload_api_upload_sdk_request(
            authorization=authorization,
            content_md5=content_md5,
            date=date,
            cms_signature=cms_signature,
    ...
    def upload_custom(
        ...
        **kwargs: Any
        ...
        _request = build_upload_api_upload_custom_request(
            authorization=authorization,
            content_md5=content_md5,
            date=date,
            cms_signature=cms_signature,
