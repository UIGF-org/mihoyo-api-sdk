...
from ....community import models as _community_models4, types as _types_community_models4
from ....passport._utils.model_base import SdkJSONEncoder, _deserialize
from ....passport._utils.serialization import Deserializer, Serializer
from ...operations._operations import (
    build_check_in_api_get_home_request,
    build_check_in_api_get_info_request,
    build_check_in_api_get_resign_info_request,
    build_check_in_api_resign_request,
    build_check_in_api_sign_request,
)
...
class CheckInApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.passport.aio.CheckInClient`'s
    ...
    async def sign(
        self,
        game: str,
        body: _community_models4.LunaCheckInRequest,
        *,
        cookie: str,
    ...
    async def sign(
        self,
        game: str,
        body: _types_community_models4.LunaCheckInRequest,
        *,
        cookie: str,
        sign_game: Optional[str] = None,
        content_type: str = "application/json",
    ...
    async def sign(
        self,
        game: str,
        body: Union[_community_models4.LunaCheckInRequest, _types_community_models4.LunaCheckInRequest, IO[bytes]],
        *,
        cookie: str,
        sign_game: Optional[str] = None,
        **kwargs: Any
