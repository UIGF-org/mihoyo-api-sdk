...
{
    /// <summary> The GlobalHonkaiImpactApi sub-client. </summary>
    public partial class GlobalHonkaiImpactApi
    {
        private readonly Uri _endpoint;

        /// <summary> Initializes a new instance of GlobalHonkaiImpactApi for mocking. </summary>
        protected GlobalHonkaiImpactApi()
        {
        }
        ...
        internal GlobalHonkaiImpactApi(ClientPipeline pipeline, Uri endpoint)
        {
            _endpoint = endpoint;
            Pipeline = pipeline;
        }
