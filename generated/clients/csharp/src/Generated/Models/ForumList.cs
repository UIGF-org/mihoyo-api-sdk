...
namespace UIGF.Community
{
    ...
    public partial class ForumList
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ForumList"/>. </summary>
        internal ForumList()
        {
        ...
        internal ForumList(IList<Forum> list, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
            List = list;
