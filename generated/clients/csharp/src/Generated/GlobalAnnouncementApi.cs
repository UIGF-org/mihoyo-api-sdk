...
{
    /// <summary> The GlobalAnnouncementApi sub-client. </summary>
    public partial class GlobalAnnouncementApi
    {
        private readonly Uri _endpoint;

        /// <summary> Initializes a new instance of GlobalAnnouncementApi for mocking. </summary>
        protected GlobalAnnouncementApi()
        {
        }
        ...
        internal GlobalAnnouncementApi(ClientPipeline pipeline, Uri endpoint)
        {
            _endpoint = endpoint;
            Pipeline = pipeline;
        }
        ...
        public virtual ClientResult GetAll(string game, string gameBiz, string lang, string bundleId, string platform, string region, int? level = default, string uid = default, int? channelId = default, RequestOptions options = null)
        {
            ...
            using PipelineMessage message = CreateGetAllRequest(game, gameBiz, lang, bundleId, platform, region, level, uid, channelId, options);
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> GetAllAsync(string game, string gameBiz, string lang, string bundleId, string platform, string region, int? level = default, string uid = default, int? channelId = default, RequestOptions options = null)
        {
            Argument.AssertNotNullOrEmpty(game, nameof(game));
            Argument.AssertNotNullOrEmpty(gameBiz, nameof(gameBiz));
            Argument.AssertNotNullOrEmpty(lang, nameof(lang));
