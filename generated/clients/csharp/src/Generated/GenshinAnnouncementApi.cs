...
namespace UIGF.Game.Genshin.Announcements
{
    ...
    public partial class GenshinAnnouncementApi
    {
        ...
        /// <summary> Initializes a new instance of GenshinAnnouncementApi for mocking. </summary>
        protected GenshinAnnouncementApi()
        {
        }
        ...
        internal GenshinAnnouncementApi(ClientPipeline pipeline, Uri endpoint)
        {
            _endpoint = endpoint;
            Pipeline = pipeline;
        }
