...
namespace UIGF.Uncategorized.Telemetry.SDK
{
    ...
    public partial class SdkTelemetryUploadApi
    {
        ...
        internal PipelineMessage CreateUploadRequest(BinaryContent content, string authorization, string contentMd5, string date, string cmsSignature, RequestOptions options)
        {
