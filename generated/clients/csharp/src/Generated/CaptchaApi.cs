...
namespace UIGF.Passport
{
    ...
    public partial class CaptchaApi
    {
        ...
        /// <summary> Initializes a new instance of CaptchaApi for mocking. </summary>
        protected CaptchaApi()
        {
        }
        ...
        internal CaptchaApi(ClientPipeline pipeline, Uri endpoint)
        {
            _endpoint = endpoint;
            Pipeline = pipeline;
        }
        ...
        /// <summary>
        /// [Protocol Method] Starts the vendor login-captcha challenge. Solve it through the official flow.
        /// <list type="bullet">
        /// <item>
