...
import uigf.checkin.implementation.CnLauncherMetadataApisImpl;
import uigf.launcher.DxConfigRequest;

/**
 * Initializes a new instance of the synchronous CnLauncherClient type.
 */
@ServiceClient(builder = CnLauncherClientBuilder.class)
public final class CnLauncherClient {
    @Metadata(properties = { MetadataProperties.GENERATED })
    private final CnLauncherMetadataApisImpl serviceClient;

    private final Instrumentation instrumentation;

    /**
     * Initializes an instance of CnLauncherClient class.
     * 
     * @param serviceClient the service client implementation.
     * @param instrumentation the instrumentation instance.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    CnLauncherClient(CnLauncherMetadataApisImpl serviceClient, Instrumentation instrumentation) {
    ...
    public Response<LauncherResponseJsonObject> getDxConfigsWithResponse(String launcherId, String language,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Launcher.CN.MetadataApi.getDxConfigs", requestContext,
            updatedContext -> this.serviceClient.getDxConfigsWithResponse(launcherId, language, body, gameIds,
                updatedContext));
    }
