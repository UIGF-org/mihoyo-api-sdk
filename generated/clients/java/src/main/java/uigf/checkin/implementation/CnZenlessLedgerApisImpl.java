...
/**
 * An instance of this class provides access to all the operations defined in CnZenlessLedgerApis.
 */
public final class CnZenlessLedgerApisImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final CnZenlessLedgerApisService service;

    /**
     * The service client containing this operation class.
     */
    private final EventsClientImpl client;
    ...
    /**
     * Initializes an instance of CnZenlessLedgerApisImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    CnZenlessLedgerApisImpl(EventsClientImpl client) {
        this.service = CnZenlessLedgerApisService.getNewInstance(client.getHttpPipeline());
        this.client = client;
        this.instrumentation = client.getInstrumentation();
    }

    /**
     * The interface defining all the services for EventsClientCnZenlessLedgerApis to be used by the proxy service to
     * perform REST calls.
     */
    @ServiceInterface(name = "EventsClientCnZenlessLedgerApis", host = "{endpoint}")
    public interface CnZenlessLedgerApisService {
        static CnZenlessLedgerApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.checkin.implementation.CnZenlessLedgerApisServiceImpl");
                return (CnZenlessLedgerApisService) clazz.getMethod("getNewInstance", HttpPipeline.class)
        ...
        @HttpRequestInformation(
            ...
            path = "/event/nap_ledger/month_info",
        ...
        @HttpRequestInformation(
            method = HttpMethod.GET,
            path = "/event/nap_ledger/month_detail",
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseJsonObject> getMonthDetail(@HostParam("endpoint") String endpoint,
            @HeaderParam("Cookie") String cookie, @QueryParam("type") String type,
    ...
    public Response<ApiResponseJsonObject> getMonthInfoWithResponse(String cookie, String roleId, String server,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Game.CN.Events.ZenlessLedgerApi.getMonthInfo",
    ...
    public Response<ApiResponseJsonObject> getMonthDetailWithResponse(String cookie, String type, int currentPage,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Game.CN.Events.ZenlessLedgerApi.getMonthDetail",
            requestContext, updatedContext -> {
                final String accept = "application/json";
