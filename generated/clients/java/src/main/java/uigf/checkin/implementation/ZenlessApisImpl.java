...
/**
 * An instance of this class provides access to all the operations defined in ZenlessApis.
 */
public final class ZenlessApisImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final ZenlessApisService service;
    ...
    /**
     * Initializes an instance of ZenlessApisImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    ZenlessApisImpl(CnGameRecordsClientImpl client) {
        this.service = ZenlessApisService.getNewInstance(client.getHttpPipeline());
        this.client = client;
        this.instrumentation = client.getInstrumentation();
    }

    /**
     * The interface defining all the services for CnGameRecordsClientZenlessApis to be used by the proxy service to
     * perform REST calls.
     */
    @ServiceInterface(name = "CnGameRecordsClientZenlessApis", host = "{endpoint}")
    public interface ZenlessApisService {
        static ZenlessApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.checkin.implementation.ZenlessApisServiceImpl");
                return (ZenlessApisService) clazz.getMethod("getNewInstance", HttpPipeline.class)
        ...
        Response<ApiResponseJsonObject> getDailyNote(@HostParam("endpoint") String endpoint,
            @HeaderParam("Cookie") String cookie, @QueryParam("server") String server,
            @QueryParam("role_id") String roleId, @HeaderParam("Accept") String accept, RequestContext requestContext);
    ...
    public Response<ApiResponseJsonObject> getDailyNoteWithResponse(String cookie, String server, String roleId,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Game.CN.Records.ZenlessApi.getDailyNote",
            requestContext, updatedContext -> {
                final String accept = "application/json";
                return service.getDailyNote(this.client.getEndpoint(), cookie, server, roleId, accept, updatedContext);
            });
    }
    ...
    public Response<ApiResponseJsonObject> getThresholdSimulationSummaryWithResponse(String cookie, String region,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Game.CN.Records.ZenlessApi.getThresholdSimulationSummary", requestContext, updatedContext -> {
                final String accept = "application/json";
    ...
    public Response<ApiResponseJsonObject> getThresholdSimulationDetailWithResponse(String cookie, String region,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Game.CN.Records.ZenlessApi.getThresholdSimulationDetail", requestContext, updatedContext -> {
                final String accept = "application/json";
