...
/**
 * An instance of this class provides access to all the operations defined in GlobalZenlessLedgerApis.
 */
public final class GlobalZenlessLedgerApisImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final GlobalZenlessLedgerApisService service;
    ...
    /**
     * Initializes an instance of GlobalZenlessLedgerApisImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    GlobalZenlessLedgerApisImpl(GlobalGameRecordsClientImpl client) {
        this.service = GlobalZenlessLedgerApisService.getNewInstance(client.getHttpPipeline());
        this.client = client;
        this.instrumentation = client.getInstrumentation();
    }

    /**
     * The interface defining all the services for GlobalGameRecordsClientGlobalZenlessLedgerApis to be used by the
     * proxy service to perform REST calls.
     */
    @ServiceInterface(name = "GlobalGameRecordsClientGlobalZenlessLedgerApis", host = "{endpoint}")
    public interface GlobalZenlessLedgerApisService {
        static GlobalZenlessLedgerApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.checkin.implementation.GlobalZenlessLedgerApisServiceImpl");
                return (GlobalZenlessLedgerApisService) clazz.getMethod("getNewInstance", HttpPipeline.class)
