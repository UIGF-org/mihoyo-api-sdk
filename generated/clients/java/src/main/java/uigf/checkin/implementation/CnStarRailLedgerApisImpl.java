...
/**
 * An instance of this class provides access to all the operations defined in CnStarRailLedgerApis.
 */
public final class CnStarRailLedgerApisImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final CnStarRailLedgerApisService service;
    ...
    /**
     * Initializes an instance of CnStarRailLedgerApisImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    CnStarRailLedgerApisImpl(EventsClientImpl client) {
        this.service = CnStarRailLedgerApisService.getNewInstance(client.getHttpPipeline());
        this.client = client;
        this.instrumentation = client.getInstrumentation();
    }

    /**
     * The interface defining all the services for EventsClientCnStarRailLedgerApis to be used by the proxy service to
     * perform REST calls.
     */
    @ServiceInterface(name = "EventsClientCnStarRailLedgerApis", host = "{endpoint}")
    public interface CnStarRailLedgerApisService {
        static CnStarRailLedgerApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.checkin.implementation.CnStarRailLedgerApisServiceImpl");
                return (CnStarRailLedgerApisService) clazz.getMethod("getNewInstance", HttpPipeline.class)
    ...
    public Response<ApiResponseJsonObject> getMonthInfoWithResponse(String cookie, String roleId, String server,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Game.CN.Events.StarRailLedgerApi.getMonthInfo",
    ...
    public Response<ApiResponseJsonObject> getMonthDetailWithResponse(String cookie, int type, int currentPage,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Game.CN.Events.StarRailLedgerApi.getMonthDetail",
            requestContext, updatedContext -> {
                final String accept = "application/json";
