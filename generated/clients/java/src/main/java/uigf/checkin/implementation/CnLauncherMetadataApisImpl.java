...
/**
 * An instance of this class provides access to all the operations defined in CnLauncherMetadataApis.
 */
public final class CnLauncherMetadataApisImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final CnLauncherMetadataApisService service;

    /**
     * The service client containing this operation class.
     */
    private final CnLauncherClientImpl client;
    ...
    /**
     * Initializes an instance of CnLauncherMetadataApisImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    CnLauncherMetadataApisImpl(CnLauncherClientImpl client) {
        this.service = CnLauncherMetadataApisService.getNewInstance(client.getHttpPipeline());
        this.client = client;
        this.instrumentation = client.getInstrumentation();
    }

    /**
     * The interface defining all the services for CnLauncherClientCnLauncherMetadataApis to be used by the proxy
     * service to perform REST calls.
     */
    @ServiceInterface(name = "CnLauncherClientCnLauncherMetadataApis", host = "{endpoint}")
    public interface CnLauncherMetadataApisService {
        static CnLauncherMetadataApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.checkin.implementation.CnLauncherMetadataApisServiceImpl");
                return (CnLauncherMetadataApisService) clazz.getMethod("getNewInstance", HttpPipeline.class)
    ...
    public Response<LauncherResponseGameBasicInfo> getAllGameBasicInfoWithResponse(String launcherId, String language,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Launcher.CN.MetadataApi.getAllGameBasicInfo",
    ...
    public Response<LauncherResponseJsonObject> getGamePackagesWithResponse(String launcherId, String language,
        List<String> gameIds, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Launcher.CN.MetadataApi.getGamePackages",
            requestContext, updatedContext -> {
                final String accept = "application/json";
                String gameIdsConverted = (gameIds == null)
                    ? null
    ...
    public Response<LauncherResponseJsonObject> getGameChannelSdksWithResponse(String launcherId, String language,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Launcher.CN.MetadataApi.getGameChannelSdks",
            requestContext, updatedContext -> {
                final String accept = "application/json";
                String gameIdsConverted = (gameIds == null)
                    ? null
    ...
    public Response<LauncherResponseJsonObject> getDeprecatedFileConfigsWithResponse(String launcherId, String language,
        Integer channel, Integer subChannel, List<String> gameIds, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Launcher.CN.MetadataApi.getDeprecatedFileConfigs",
            requestContext, updatedContext -> {
                final String accept = "application/json";
                String gameIdsConverted = (gameIds == null)
                    ? null
    ...
    public Response<LauncherResponseJsonObject> getGameConfigsWithResponse(String launcherId, String language,
        List<String> gameIds, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Launcher.CN.MetadataApi.getGameConfigs",
            requestContext, updatedContext -> {
                final String accept = "application/json";
                String gameIdsConverted = (gameIds == null)
                    ? null
    ...
    public Response<LauncherResponseJsonObject> getGameScanInfoWithResponse(String launcherId, String language,
        List<String> gameIds, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Launcher.CN.MetadataApi.getGameScanInfo",
            requestContext, updatedContext -> {
                final String accept = "application/json";
                String gameIdsConverted = (gameIds == null)
                    ? null
    ...
    public Response<LauncherResponseJsonObject> getGameBranchesWithResponse(String launcherId, String language,
        List<String> gameIds, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Launcher.CN.MetadataApi.getGameBranches",
            requestContext, updatedContext -> {
                final String accept = "application/json";
                String gameIdsConverted = (gameIds == null)
                    ? null
    ...
    public Response<LauncherResponseJsonObject> getWpfPackagesWithResponse(String launcherId, String language,
        List<String> gameIds, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Launcher.CN.MetadataApi.getWpfPackages",
            requestContext, updatedContext -> {
                final String accept = "application/json";
                String gameIdsConverted = (gameIds == null)
                    ? null
    ...
    public Response<LauncherResponseJsonObject> getDxConfigsWithResponse(String launcherId, String language,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Launcher.CN.MetadataApi.getDxConfigs", requestContext,
            updatedContext -> {
