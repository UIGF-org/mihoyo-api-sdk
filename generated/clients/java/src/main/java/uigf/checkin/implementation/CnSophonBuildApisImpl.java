...
/**
 * An instance of this class provides access to all the operations defined in CnSophonBuildApis.
 */
public final class CnSophonBuildApisImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final CnSophonBuildApisService service;

    /**
     * The service client containing this operation class.
     */
    private final CnSophonClientImpl client;
    ...
    /**
     * Initializes an instance of CnSophonBuildApisImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    CnSophonBuildApisImpl(CnSophonClientImpl client) {
        this.service = CnSophonBuildApisService.getNewInstance(client.getHttpPipeline());
        this.client = client;
        this.instrumentation = client.getInstrumentation();
    }

    /**
     * The interface defining all the services for CnSophonClientCnSophonBuildApis to be used by the proxy service to
     * perform REST calls.
     */
    @ServiceInterface(name = "CnSophonClientCnSophonBuildApis", host = "{endpoint}")
    public interface CnSophonBuildApisService {
        static CnSophonBuildApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.checkin.implementation.CnSophonBuildApisServiceImpl");
                return (CnSophonBuildApisService) clazz.getMethod("getNewInstance", HttpPipeline.class)
