...
/**
 * An instance of this class provides access to all the operations defined in CnZenlessCultivationApis.
 */
public final class CnZenlessCultivationApisImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final CnZenlessCultivationApisService service;
    ...
    /**
     * Initializes an instance of CnZenlessCultivationApisImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    CnZenlessCultivationApisImpl(EventsClientImpl client) {
        this.service = CnZenlessCultivationApisService.getNewInstance(client.getHttpPipeline());
        this.client = client;
        this.instrumentation = client.getInstrumentation();
    }

    /**
     * The interface defining all the services for EventsClientCnZenlessCultivationApis to be used by the proxy service
     * to perform REST calls.
     */
    @ServiceInterface(name = "EventsClientCnZenlessCultivationApis", host = "{endpoint}")
    public interface CnZenlessCultivationApisService {
        static CnZenlessCultivationApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.checkin.implementation.CnZenlessCultivationApisServiceImpl");
                return (CnZenlessCultivationApisService) clazz.getMethod("getNewInstance", HttpPipeline.class)
