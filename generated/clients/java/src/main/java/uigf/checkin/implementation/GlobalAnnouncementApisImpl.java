...
/**
 * An instance of this class provides access to all the operations defined in GlobalAnnouncementApis.
 */
public final class GlobalAnnouncementApisImpl {
    /**
     * The proxy service used to perform REST calls.
     */
    private final GlobalAnnouncementApisService service;
    ...
    /**
     * Initializes an instance of GlobalAnnouncementApisImpl.
     * 
     * @param client the instance of the service client containing this operation class.
     */
    GlobalAnnouncementApisImpl(GenshinClientImpl client) {
        this.service = GlobalAnnouncementApisService.getNewInstance(client.getHttpPipeline());
        this.client = client;
        this.instrumentation = client.getInstrumentation();
    }

    /**
     * The interface defining all the services for GenshinClientGlobalAnnouncementApis to be used by the proxy service
     * to perform REST calls.
     */
    @ServiceInterface(name = "GenshinClientGlobalAnnouncementApis", host = "{endpoint}")
    public interface GlobalAnnouncementApisService {
        static GlobalAnnouncementApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.checkin.implementation.GlobalAnnouncementApisServiceImpl");
                return (GlobalAnnouncementApisService) clazz.getMethod("getNewInstance", HttpPipeline.class)
        ...
        @HttpRequestInformation(
            ...
            path = "/common/hk4e_global/announcement/api/getAnnList",
        ...
        @HttpRequestInformation(
            method = HttpMethod.GET,
            path = "/common/hk4e_global/announcement/api/getAnnContent",
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        ...
        @HttpRequestInformation(
            method = HttpMethod.GET,
            path = "/common/hk4e_global/announcement/api/getAlertAnn",
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
