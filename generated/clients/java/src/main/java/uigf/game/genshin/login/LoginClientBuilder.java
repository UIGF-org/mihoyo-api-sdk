...
import uigf.checkin.implementation.LoginClientImpl;
...
public final class LoginClientBuilder implements HttpTrait<LoginClientBuilder>, ProxyTrait<LoginClientBuilder>,
    ...
    /**
     * Create an instance of the LoginClientBuilder.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @Override
    public LoginClientBuilder httpClient(HttpClient httpClient) {
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @Override
    public LoginClientBuilder httpRetryOptions(HttpRetryOptions retryOptions) {
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @Override
    public LoginClientBuilder addHttpPipelinePolicy(HttpPipelinePolicy customPolicy) {
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @Override
    public LoginClientBuilder httpRedirectOptions(HttpRedirectOptions redirectOptions) {
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @Override
    public LoginClientBuilder httpInstrumentationOptions(HttpInstrumentationOptions httpInstrumentationOptions) {
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @Override
    public LoginClientBuilder proxyOptions(ProxyOptions proxyOptions) {
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @Override
    public LoginClientBuilder configuration(Configuration configuration) {
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @Override
    public LoginClientBuilder endpoint(String endpoint) {
        this.endpoint = endpoint;
        return this;
    }

    /**
     * Builds an instance of LoginClientImpl with the provided parameters.
     * 
     * @return an instance of LoginClientImpl.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    private LoginClientImpl buildInnerClient() {
        this.validateClient();
        ...
        LoginClientImpl client = new LoginClientImpl(createHttpPipeline(), instrumentation, localEndpoint);
        return client;
    }
