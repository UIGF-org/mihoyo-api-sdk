...
import uigf.checkin.implementation.GlobalStarRailLedgerApisImpl;
...
public final class GlobalStarRailLedgerApiClient {
    @Metadata(properties = { MetadataProperties.GENERATED })
    private final GlobalStarRailLedgerApisImpl serviceClient;

    private final Instrumentation instrumentation;

    /**
     * Initializes an instance of GlobalStarRailLedgerApiClient class.
     * 
     * @param serviceClient the service client implementation.
     * @param instrumentation the instrumentation instance.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    GlobalStarRailLedgerApiClient(GlobalStarRailLedgerApisImpl serviceClient, Instrumentation instrumentation) {
