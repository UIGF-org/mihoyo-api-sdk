...
import uigf.checkin.implementation.CnZenlessLedgerApisImpl;

/**
 * Initializes a new instance of the synchronous EventsClient type.
 */
@ServiceClient(builder = EventsClientBuilder.class)
public final class CnZenlessLedgerApiClient {
    @Metadata(properties = { MetadataProperties.GENERATED })
    private final CnZenlessLedgerApisImpl serviceClient;

    private final Instrumentation instrumentation;

    /**
     * Initializes an instance of CnZenlessLedgerApiClient class.
     * 
     * @param serviceClient the service client implementation.
     * @param instrumentation the instrumentation instance.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    CnZenlessLedgerApiClient(CnZenlessLedgerApisImpl serviceClient, Instrumentation instrumentation) {
