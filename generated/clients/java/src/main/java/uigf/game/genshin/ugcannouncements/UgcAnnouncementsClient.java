...
import uigf.checkin.implementation.UgcApisImpl;

/**
 * Initializes a new instance of the synchronous UgcAnnouncementsClient type.
 */
@ServiceClient(builder = UgcAnnouncementsClientBuilder.class)
public final class UgcAnnouncementsClient {
    @Metadata(properties = { MetadataProperties.GENERATED })
    private final UgcApisImpl serviceClient;

    private final Instrumentation instrumentation;

    /**
     * Initializes an instance of UgcAnnouncementsClient class.
     * 
     * @param serviceClient the service client implementation.
     * @param instrumentation the instrumentation instance.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    UgcAnnouncementsClient(UgcApisImpl serviceClient, Instrumentation instrumentation) {
