...
import uigf.checkin.implementation.CnStarRailLedgerApisImpl;

/**
 * Initializes a new instance of the synchronous EventsClient type.
 */
@ServiceClient(builder = EventsClientBuilder.class)
public final class CnStarRailLedgerApiClient {
    @Metadata(properties = { MetadataProperties.GENERATED })
    private final CnStarRailLedgerApisImpl serviceClient;

    private final Instrumentation instrumentation;

    /**
     * Initializes an instance of CnStarRailLedgerApiClient class.
     * 
     * @param serviceClient the service client implementation.
     * @param instrumentation the instrumentation instance.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    CnStarRailLedgerApiClient(CnStarRailLedgerApisImpl serviceClient, Instrumentation instrumentation) {
    ...
    public ApiResponseJsonObject getMonthDetail(String cookie, int type, int currentPage, String roleId, String server,
        Integer pageSize, String month, String lang) {
