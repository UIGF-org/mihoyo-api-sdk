...
import uigf.checkin.implementation.GlobalZenlessCultivationApisImpl;
...
public final class GlobalZenlessCultivationApiClient {
    @Metadata(properties = { MetadataProperties.GENERATED })
    private final GlobalZenlessCultivationApisImpl serviceClient;

    private final Instrumentation instrumentation;

    /**
     * Initializes an instance of GlobalZenlessCultivationApiClient class.
     * 
     * @param serviceClient the service client implementation.
     * @param instrumentation the instrumentation instance.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    GlobalZenlessCultivationApiClient(GlobalZenlessCultivationApisImpl serviceClient, Instrumentation instrumentation) {
