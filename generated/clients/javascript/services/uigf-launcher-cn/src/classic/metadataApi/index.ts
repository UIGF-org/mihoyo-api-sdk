...
import { LauncherCNContext } from "../../api/launcherCNContext.js";
import {
  getDxConfigs,
  getWpfPackages,
  getGameBranches,
...
function _getMetadataApi(context: LauncherCNContext) {
  return {
    getDxConfigs: (
      launcherId: string,
      language: string,
...
export function _getMetadataApiOperations(context: LauncherCNContext): MetadataApiOperations {
  return {
