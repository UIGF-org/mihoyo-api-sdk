...
export function _getThresholdSimulationDetailSend(
  ...
  uid: string,
  voidFrontId: number,
  options: ZenlessApiGetThresholdSimulationDetailOptionalParams = { requestOptions: {} },
): StreamableMethod {
...
export function _getThresholdSimulationSummarySend(
  ...
  region: string,
  uid: string,
  options: ZenlessApiGetThresholdSimulationSummaryOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _getGachaRecordSend(
  ...
  region: string,
  gachaType: number,
  options: ZenlessApiGetGachaRecordOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _getDailyNoteSend(
  ...
  server: string,
  roleId: string,
  options: ZenlessApiGetDailyNoteOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
...
export function _getIndexSend(
  ...
  server: string,
  roleId: string,
  options: ZenlessApiGetIndexOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
