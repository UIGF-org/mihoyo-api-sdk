...
import { GameCNHonkaiImpactContext as Client } from "../index.js";
import {
  ApiResponseJsonObject,
  apiResponseJsonObjectDeserializer,
} from "../../models/uigf/models.js";
import { expandUrlTemplate } from "../../static-helpers/urlTemplate.js";
import { DailyNoteApiGetDailyNoteOptionalParams } from "./options.js";
import {
  StreamableMethod,
...
export function _getDailyNoteSend(
  ...
  server: string,
  roleId: string,
  options: DailyNoteApiGetDailyNoteOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/game_record/appv2/honkai3rd/api/note{?server,role_id}",
    {
      server: server,
      role_id: roleId,
    },
