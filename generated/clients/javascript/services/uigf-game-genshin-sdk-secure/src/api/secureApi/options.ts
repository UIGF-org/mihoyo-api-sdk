...
/** Optional parameters. */
export interface SecureApiGetRedDotsOptionalParams extends OperationOptions {
  rpcAppId?: string;
...
/** Optional parameters. */
export interface SecureApiCompareProtocolVersionOptionalParams extends OperationOptions {
  rpcAppId?: string;
  rpcAppVersion?: string;
  rpcChannelId?: string;
  rpcChannelVersion?: string;
